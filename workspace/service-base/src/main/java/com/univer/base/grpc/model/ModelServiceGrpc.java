...
public final class ModelServiceGrpc {
  ...
  public static final String SERVICE_NAME = "model.ModelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.univer.base.grpc.model.ModelRequest,
      com.univer.base.grpc.model.ModelResponse> getPredictMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "predict",
      requestType = com.univer.base.grpc.model.ModelRequest.class,
      responseType = com.univer.base.grpc.model.ModelResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.univer.base.grpc.model.ModelRequest,
      com.univer.base.grpc.model.ModelResponse> getPredictMethod() {
    io.grpc.MethodDescriptor<com.univer.base.grpc.model.ModelRequest, com.univer.base.grpc.model.ModelResponse> getPredictMethod;
    if ((getPredictMethod = ModelServiceGrpc.getPredictMethod) == null) {
      synchronized (ModelServiceGrpc.class) {
        if ((getPredictMethod = ModelServiceGrpc.getPredictMethod) == null) {
          ModelServiceGrpc.getPredictMethod = getPredictMethod = 
              io.grpc.MethodDescriptor.<com.univer.base.grpc.model.ModelRequest, com.univer.base.grpc.model.ModelResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "model.ModelService", "predict"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.univer.base.grpc.model.ModelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.univer.base.grpc.model.ModelResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new ModelServiceMethodDescriptorSupplier("predict"))
                  .build();
          }
        }
     }
  ...
  public static abstract class ModelServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void predict(com.univer.base.grpc.model.ModelRequest request,
        io.grpc.stub.StreamObserver<com.univer.base.grpc.model.ModelResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.univer.base.grpc.model.ModelRequest,
                com.univer.base.grpc.model.ModelResponse>(
  ...
  public static final class ModelServiceBlockingStub extends io.grpc.stub.AbstractStub<ModelServiceBlockingStub> {
    ...
    /**
     */
    public com.univer.base.grpc.model.ModelResponse predict(com.univer.base.grpc.model.ModelRequest request) {
  ...
  public static final class ModelServiceFutureStub extends io.grpc.stub.AbstractStub<ModelServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.univer.base.grpc.model.ModelResponse> predict(
        com.univer.base.grpc.model.ModelRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PREDICT:
          serviceImpl.predict((com.univer.base.grpc.model.ModelRequest) request,
              (io.grpc.stub.StreamObserver<com.univer.base.grpc.model.ModelResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ModelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.univer.base.grpc.model.Model.getDescriptor();
    }
